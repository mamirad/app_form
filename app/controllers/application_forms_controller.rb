class ApplicationFormsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @application_form.save
           qualitative_research_experiences = params[:application_form][:qualitative_research_experiences].reject { |c| c.empty? }
   qualitative_research_experiences.each do |n|
    QualitativeResearchExperience.create(application_form_id:@application_form.id,name:n)
   end
  ...
  private
    ...
    def application_form_params
      ...
      params.require(:application_form).permit(:name, :cnic, :age, :gender, :address, :mobile_number, :apply_for, :highest_education, :subject_or_areas, :upload_cv)
    end
end
